...
local SKYRETRO_PROBE = 0x4020
local SKYRETRO_BOOT_FLAGS = 0x4021
local SKYRETRO_PORTAL_EXISTS = 0x4022
local SKYRETRO_IS_AUD_PORTAL = 0x4023
local SKYRETRO_PORTAL_STATE = 0x4024
local SKYRETRO_EMUCRT_SET = 0x4025
local SKYRETRO_EMUCRT_GET = 0x4026
local SKYRETRO_FIG_PRESCENCE = 0x4027
local SKYRETRO_CMD_PORT = 0x4028
local SKYRETRO_CMD_OUT = 0x4029
local SKYRETRO_RAW_FIG_PRESCENCE0 = 0x402E
local SKYRETRO_RAW_FIG_PRESCENCE1 = 0x402F
